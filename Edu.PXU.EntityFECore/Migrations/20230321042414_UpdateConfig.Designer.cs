...
namespace Edu.PXU.EntityFECore.Migrations
{
    ...
    [Migration("20230321042414_UpdateConfig")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Edu.PXU.EntityFECore.Entity.Role", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Edu.PXU.EntityFECore.Entity.UserIdentity", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Edu.PXU.EntityFECore.Entity.ProductImage", b =>
                {
                    ...
                    b.HasOne("Edu.PXU.EntityFECore.Entity.Image", null)
                        .WithMany("ProductImages")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("Edu.PXU.EntityFECore.Entity.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Edu.PXU.EntityFECore.Entity.UserIdentity", null)
                        .WithMany()
